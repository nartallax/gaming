#ifndef __L2CLICLI_TO_LOGIN_SERVER_PACKAGES__
#define __L2CLICLI_TO_LOGIN_SERVER_PACKAGES__

/* Запись в бинарном виде и шифрование пакетов, отправляемых логин-серверу */
